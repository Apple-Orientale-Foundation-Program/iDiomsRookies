...
let idioms: [Idiom] = [
    Idiom(id: 0, name: "Dare una mano", categoryCard: Idiom.Category.action, image: "action 1", isFavourite: false, meaningText: "Adoro Luca, è sempre pronto a dare una mano nei momenti di bisogno! I like Luca! He is always ready to lend a hand in times of need!", meaningTradu: "To lend a hand", historyText: "During the Roman Empire, thieves were punished with the cut of their hands. Many of these hands weren’t buried but used for decoration, and became a sacred symbol.", linkapple: "https://apple.co/2HJ44V3", linkspotify: "https://open.spotify.com/track/0lH5rCS0zHhzrSWPStwqeL?si=nxBURQWEQyWFEi2QhVwv7g", linkyoutube: "https://www.youtube.com/watch?v=C6dpQWnRII0"),
